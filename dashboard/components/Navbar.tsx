      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-2 items-center">
          <Image 
            ...
            width={48} // Added proper Image props
            height={48}
          />
        ...
        {!isAuthenticated ? (
          ...
          <img 
            src={user?.photoURL || "/default-avatar.png"} // Fallback for undefined photoURL
            alt="User profile" 
        ...
        >
          <HiOutlineSquare3Stack3D className="w-5 h-5" /> {/* Added explicit size */}
        </div>
      </div>
    </div>
  )
