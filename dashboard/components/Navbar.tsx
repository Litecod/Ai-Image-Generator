      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-2 items-center">
          <Image
            ...
            height={48}
          />
          <p className="text-[1.2rem] sm:text-[1.5rem] logo font-medium">Cartoonify 3D</p>
        </div>
        <div className=" flex gap-[1rem]">
          {isAuthenticated ? (
            ...
            <div className="flex items-center gap-[1rem]">
              <button className="sm:flex items-center gap-[0.3rem] text-gray-200 border border-gray-600 py-[0.3rem] px-[0.7rem] rounded-xl hover:bg-gray-800 duration-150 hidden">{imageGen} <BsFillSuitDiamondFill /></button>
              <Link href={"/pricing"} className="flex items-center gap-[0.3rem] text-[#8a40fc] py-[0.3rem] px-[0.7rem] rounded-xl hover:bg-gray-800 duration-150 bg-[#170039]"><FaCrown /> <span className="hidden sm:block">Upgrade</span></Link>
              <img
